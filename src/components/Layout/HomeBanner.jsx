...
function HomeBanner() {
  return (
    <div
      className="w-full md:h-[100vh] py-3 md:py-0 bg-[#15303e] font-mub gap-3 flex md:flex-row 
    flex-col-reverse
    ...
    >
      ...
      <div className="flex gap-3 relative  md:w-1/2 ">
        <img
          src={bgpic}
          alt=""
          className="rounded-lg md:rounded-sm shadow-sm  md:w-[25rem] md:h-[30rem] mt-5 md:mt-0 h-80 w-96  ml-5 md:ml-0 "
        />
        <img
          src={fgpic}
          alt=""
          className="absolute w-60 rounded-md md:h-72  shadow-lg right-16 top-24 hidden md:flex "
        />
      </div>
    </div>
  );
