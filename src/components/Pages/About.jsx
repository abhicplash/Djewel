  ...
  return (
    <Layout>
      ...
      <div className="w-full px-32 flex justify-between py-20">
        <div>
          <h1 className="flex text-[#15303e]  items-center gap-2 font-extrabold uppercase text-lg font-mubu">
            <FaClock />
            Opening Hours
          </h1>
          <p className="pl-6 text-sm w-36  font-mubu font-bold">
            10am to 5pm-offline 24 hours - online
          </p>
        </div>
        <div>
          <h1 className="flex text-[#15303e]  items-center gap-2 font-extrabold uppercase text-lg font-mubu">
          ...
          <p className="pl-6 text-xs w-32  font-mubu font-bold">
        ...
        <div>
          ...
          <p className="pl-6 text-sm w-32  font-mubu font-bold">
            info@djmail.com
          </p>
        </div>
        <div>
      ...
      <div className="flex w-full justify-between items-center pb-20 px-32">
        ...
        <div className=" text-[#15303e]   ">
          <h1 className="text-3xl text-center font-mubu capitalize underline">
            follow Us on
          </h1>
